...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const butsearch = document.querySelector("#rechercher")
    butsearch.addEventListener("click", () => {
        var text = document.querySelector('#inputsearch').value
        text = "%" +text+"%"
        console.log(text)
        fetch(`../back/recherche.php?text=${text}`)
        .then(response => response.json())
        .then(data => {
            console.log(data)
            const postsContainer = document.querySelector('.posts-container');
    ...
    /*const butpost = document.querySelector(".post-button big-post-button")
